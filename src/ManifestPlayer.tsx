...
// // import { logError } from '../util/DeviceLog';
...
//         // logError(this.TAG, 'Video client error.', error);
...
//         // logError(this.TAG, 'Player emits error.', error);
...
//       });
//     } catch (error) {
//       // logError(this.TAG, 'Error requesting player.', error);
